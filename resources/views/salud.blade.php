...
@section ('busqueda')
  <div>
    ...
    <div class="parallax-container">
        <div class="parallax"><img class="responsive-image" src="imagenes/Salud.png"></div>
        <br><br><br><br><br><br><br>
        <div id="search_div_salud" class="row container">
          <section class="col s12 center white-text">
            <h4>
              En la categoría salud puedes encontrar Doctores, Clínicas, Farmacias y más!
            </h4>
          </section>
      ...
      <ul class="slides">
        <li>
          ...
          <div class="caption center-align">
            ...
            <a class="btn waves-effect white green-text" href="{{ route('cat_salud') }}">Ir a Categoría Salud</a>
          </div>
        </li>
        <li>
          ...
          <div class="caption left-align">
            ...
            <a class="btn waves-effect white orange-text text-accent-4" href="{{ route('cat_comida') }}">Ir a Categoría Comida</a>
          </div>
        </li>
        <li>
